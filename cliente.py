...
class EntidadBase(ABC):
    ...
    def __init__(self, id_entidad: str):
        ...
        """
        # Identificador protegido de la entidad
        self._id = id_entidad
...
class Cliente(EntidadBase):
    ...
    def __init__(self, nombre: str, email: str, telefono: str, documento: str):
        ...
        """
        # Validar todos los campos antes de asignar
        ...
        # Asignar atributos privados (encapsulación)
    ...
    def agregar_reserva(self, reserva):
        ...
        """
        # Verificar que el cliente esté activo antes de agregar
        if not self.__activo:
            raise ClienteInvalidoError(f"El cliente '{self.__nombre}' está inactivo.")
        # Agregar la reserva a la lista interna
    ...
    def _validar_campos(self, nombre: str, email: str, telefono: str, documento: str):
        ...
        # Validar que el documento no esté vacío y tenga mínimo 5 caracteres
    ...
    def validar(self) -> bool:
        ...
        try:
            # Re-validar todos los campos actualmente almacenados
